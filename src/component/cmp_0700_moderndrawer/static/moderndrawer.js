(() => {
    ...
    const INIT_FLAG = 'moderndrawerInitialized';
    ...
    function initDrawer() {
        ...
        if (drawer.dataset[INIT_FLAG] === '1') {
            return;
        }
        drawer.dataset[INIT_FLAG] = '1';
    ...
    window.addEventListener('neutralFetchCompleted', initDrawer);
})();
