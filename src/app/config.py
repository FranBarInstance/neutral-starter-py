...
class Config: # pylint: disable=too-few-public-methods
    ...
    MAIL_TEMPLATE_NAME = config.get('MAIL_TEMPLATE_NAME', 'index.ntpl')
    ...
    PIN_ACCOUNT_EXPIRES_SECONDS = int(config.get('PIN_ACCOUNT_EXPIRES_SECONDS', 3600))
    ...
    ROLES = ["localdev", "admin", "moderator", "editor", "any"]
